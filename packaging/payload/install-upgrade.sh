...
grep -qx 'logical_regular_file_cap_bytes=192512' "$self/persistent.contract" || die 'persistent cap mismatch'
grep -qx 'final_free_reserve_bytes=69632' "$self/persistent.contract" || die 'free-space reserve mismatch'
...
grep -qx 'maintenance_regular_file_cap_bytes=192512' "$self/persistent.contract" || die 'maintenance cap mismatch'
