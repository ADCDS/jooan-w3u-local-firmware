...
- In steady state, keep the compressed controller/SSH material plus exactly one
  stable runtime at or below **184320 bytes (180 KiB)** and require at least
  **77824 bytes (76 KiB)** free.
- During update, require durable controller-owned SSH recovery before selecting
  ...
  under the same **184320-byte (180 KiB)** cap while preserving at least **57344
  ...
  the candidate and restore the 76 KiB steady reserve.
